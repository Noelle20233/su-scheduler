...
# 版本一致性：RUNTIME_LIB_VERSION = 1.29.0（P5-06 递增，B5 版本线同步）
[ "$(grep '^RUNTIME_LIB_VERSION=' "$RTLIB" | cut -d= -f2 | tr -d '"')" = "1.29.0" ] \
    && ok "P5-06 version: RUNTIME_LIB_VERSION=1.29.0 (P5-06 WebUI 实时状态增强)" \
